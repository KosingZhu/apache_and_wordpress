...
?>
<header id="wf_header" class="wf_header header--three">
			...
			<div class="wf_header-navwrapperinner">
				...
				<div class="wf_navbar wf-d-none wf-d-lg-block">
					<div class="wf-container">
						<div class="wf-row align-items-center wf-py-5">
					...
					<div class="wf_navbar-wrapper <?php if($shopire_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','minicart'); endif; ?>">
						<div class="wf-container">
				...
				<div class="wf_mobilenav wf-d-lg-none <?php if($shopire_hs_hdr_sticky=='1'): esc_attr_e('is--sticky','minicart'); endif; ?>">
...
<div class="wf-header-image wf-my-4">
	<div class="wf-container">
		<div class="wf-row">
			<div class="wf-col-12">
